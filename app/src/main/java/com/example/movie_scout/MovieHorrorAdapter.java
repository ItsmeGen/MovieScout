...
public class MovieHorrorAdapter extends RecyclerView.Adapter<MovieHorrorAdapter.MovieViewHolder> {

    private List<Movie> movieList;

    public MovieHorrorAdapter(List<Movie> movieList) {
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_movie_horror2 , parent, false);
